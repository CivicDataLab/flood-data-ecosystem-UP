...
OD_VILLAGES = pd.read_csv(os.getcwd()+r'/flood-data-ecosystem-UP\Maps\Geojson\ODISHA_VILLAGES_MASTER.csv', encoding='utf-8').dropna()
...
MASTER_DF.to_csv(os.getcwd()+r'/flood-data-ecosystem-UP\/Sources/TENDERS/data/floodtenders_blockgeotagged.csv')
