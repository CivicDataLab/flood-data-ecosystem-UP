...
# -------------------------------------------------------------------
worldpop_dir = Path(
    "/Users/stephensmathew/cdl_rep/flood-data-ecosystem-UP/Sources/WORLDPOP/data"
)  # Folder containing worldpopstats_YYYY.csv

demographic_dir = Path(
    "/Users/stephensmathew/cdl_rep/flood-data-ecosystem-UP/Sources/WORLDPOP/data/agesexstructure"
)  # Folder containing demographic data by year folders
...
def normalize_name(name: str) -> str:
    """
    Normalize tehsil/subdistrict names:
      - replace '-' with space
