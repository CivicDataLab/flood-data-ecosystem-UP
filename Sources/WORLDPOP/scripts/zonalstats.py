...
#output_dir = os.path.normpath(os.path.join(path, "..", "data"))
#os.makedirs(output_dir, exist_ok=True)

#output_path = os.path.join(output_dir, f"worldpopstats_{year}.csv")
pop_zonal_stats_df.to_csv(r"D:\CDL\flood-data-ecosystem-UP\Sources\WORLDPOP\data\worldpopstats_2020.csv", index=False)
